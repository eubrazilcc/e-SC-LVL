...
class NormalizeAll implements NameNormalizer
{
    ...
    public NormalizeAll(String nameFormat, StringColumn originalNames, StringColumn normalizedNames) {
        this.seqNo = 1;
    ...
    public String normalize(String sequenceName) throws DataException {
        if (!collidingNames.contains(sequenceName) || sequenceNames.contains(sequenceName)) {
