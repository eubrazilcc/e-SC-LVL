...
public class Mega_MP implements WorkflowBlock
{
    ...
    public void execute(BlockEnvironment env, BlockInputs inputs, BlockOutputs outputs) throws Exception
    {
        ...
        execute_N_way(env, args, inputs.getInputFiles(Input_DATA), outputAnalyses, outputConsensus, outputSummaries);
    ...
    private void execute_N_way(BlockEnvironment env, ArrayList<String> args, List<File> inputFiles, List<File> outAnalysisFiles, List<File> outConsensusFiles, List<File> outSummaryFiles)
    throws Exception
    {
        ...
        for (File inputFile : inputFiles) {
            ...
            outSummaryFiles.add(new File(outputFile.toString() + "_summary.txt"));
        }
    }
}
