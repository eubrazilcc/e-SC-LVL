...
public class Mega_NJ implements WorkflowBlock
{
    ...
    private final static String Prop_SUBSTS = "Substitutions to Include";
    private final static String Prop_RATES = "Rates among Sites";
    private final static String Prop_GAMMA = "Gamma Parameter";
    ...
    throws Exception
    {
        ...
        options.add(new String[] { Prop_GAMMA, Double.toString(env.getDoubleProperty(Prop_GAMMA, -1.0)) });
        ...
        options.add(new String[] { Prop_RATES, env.getStringProperty(Prop_RATES, "") });
        options.add(new String[] { Prop_SUBSTS, env.getStringProperty(Prop_SUBSTS, "") });
